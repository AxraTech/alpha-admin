...
const InvoiceListTable = () => {
  ...
  const { data: serviceTokenTabs } = useSuspenseQuery(SERVICE_TOKEN_TABS, {
    variables: { user_id: userIds.users_by_pk.id }
  })

  // States
  const [rowSelection, setRowSelection] = useState({})
  const [data, setData] = useState(...[serviceTokenTabs.service_tokens])
    ...
    () => [
      columnHelper.accessor('id', {
        ...
        cell: ({ row }) => (
          <Typography
            component={Link}
            href={getLocalizedUrl(`/service_tokens/details/${row.original.id}`, locale)}
            color='primary'
