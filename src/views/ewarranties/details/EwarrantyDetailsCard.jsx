...
const OrderTable = ({ warrantyData }) => {
  // States

  const [rowSelection, setRowSelection] = useState({})

  const [data, setData] = useState(...[warrantyData.order_items])
...
const EwarrantyDetailsCard = ({ warrantyData }) => {
  return (
    ...
    //     // }
    //   />
    //   {/* <OrderTable warrantyData={warrantyData} /> */}
    ...
    //           {warrantyData?.items_total?.toLocaleString()} Ks
    //         </Typography>
    //       </div>
    ...
    //         </Typography>
    //         <Typography color='text.primary' className='font-medium'>
    //           {warrantyData?.total?.toLocaleString()} Ks
    //         </Typography>
    //       </div>
    //     </div>
    //   </CardContent> */}
