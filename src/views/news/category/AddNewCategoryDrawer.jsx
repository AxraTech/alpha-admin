...
import { ADD_CATEGORY, ADD_NEWS_CAT } from '@/graphql/mutations'
...
const AddNewCategoryDrawer = props => {
  ...
  const [addNewCategory] = useMutation(ADD_NEWS_CAT)
  ...
  const handleFormSubmit = async data => {
    ...
    setData([...newData, res.data.insert_news_categories_one])
    handleReset()
