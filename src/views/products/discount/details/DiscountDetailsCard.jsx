...
const OrderTable = ({ discountData }) => {
  ...
  const [data, setData] = useState(...[discountData.order_items])
  ...
  return (
    <Card>
      <CardHeader
        ...
        // }
      />
      {/* <OrderTable discountData={discountData} /> */}
        ...
        <div>
          <div className='flex items-center gap-12'>
            ...
            <Typography color='text.primary' className='font-medium'>
              {discountData?.discounted_value?.toLocaleString()} Ks
            </Typography>
          </div>
          <div className='flex items-center gap-12'>
            <Typography color='text.primary' className='min-is-[100px]'>
            ...
            <Typography color='text.primary' className='font-medium'>
              {discountData?.delivery_fee?.toLocaleString()}
            </Typography>
          </div>
          {/* <div className='flex items-center gap-12'>
            <Typography color='text.primary' className='min-is-[100px]'>
          ...
          <div className='flex items-center gap-12'>
            ...
            <Typography color='text.primary' className='font-medium'>
              {discountData?.total?.toLocaleString()} Ks
            </Typography>
          </div>
        </div>
      </CardContent>
