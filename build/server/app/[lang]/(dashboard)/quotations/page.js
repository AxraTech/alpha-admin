...
`},26808:(e,t,i)=>{"use strict";i.d(t,{Q:()=>a});let a=e=>e.split(/\s/).reduce((e,t)=>e+=t.slice(0,1),"")},82491:(e,t,i)=>{"use strict";i.d(t,{default:()=>T});var a=i(27486),s=i(61766),r=i(618),d=i(38165),n=i(46811),o=i(69121),l=i(51259),u=i(12964),c=i(72660),_=i(16561),m=i(9594),p=i(30785),g=i(44182),$=i(50822),x=i(95727),h=i(23467),P=i(2598),v=i(19396),b=i.n(v),j=i(61359),f=i(36514),w=i(57229);i(48398);var y=i(81636),S=i(93889);i(26808);var k=i(11158),N=i(31538),C=i.n(N),q=i(45882),Z=i(25009),R=i(86528);i(66718);var A=i(24458);let U=(e,t,i,a)=>{let s=(0,j.O4)(e.getValue(t),i);return a({itemRank:s}),s.passed},I=({value:e,onChange:t,debounce:i=500,...s})=>{let[d,n]=(0,r.useState)(e);return(0,r.useEffect)(()=>{n(e)},[e]),(0,r.useEffect)(()=>{let e=setTimeout(()=>{t(d)},i);return()=>clearTimeout(e)},[d]),a.jsx(p.Z,{...s,value:d,onChange:e=>n(e.target.value),size:"small"})},M=(0,f.Cl)(),D=[{label:"Quotation Number",key:"quotation_number"},{label:"UserName",key:"name"},{label:"Status",key:"status"},{label:"Created At",key:"created_at"},{label:"Updated At",key:"updated_at"}],E=()=>{let{data:e}=(0,q.kJ)(Z.kQ),{data:t}=(0,q.kJ)(Z.KH),[i,s]=(0,r.useState)(""),[p,v]=(0,r.useState)({}),[j,y]=(0,r.useState)(e.quotations),[N,E]=(0,r.useState)(j),[Q,T]=(0,r.useState)(""),{lang:z}=(0,n.useParams)(),F=N.map(e=>({...e,name:e.user.name,status:e.status,created_at:new Date(e.created_at).toLocaleString(),updated_at:new Date(e.updated_at).toLocaleString()})),J=(0,r.useMemo)(()=>[M.accessor("quotation_number",{header:"Quotation Number",cell:({row:e})=>a.jsx(c.Z,{component:d.default,href:(0,k.U)(`/quotation/preview${e.original.quotation_number}`,z),color:"primary",children:`${e.original.quotation_number}`})}),M.accessor("user.name",{header:"Client",cell:({row:e})=>(0,a.jsxs)("div",{className:"flex items-center gap-3",children:[a.jsx(R.Z,{src:e.original.user.profile_picture_url,width:"100px",height:"100px"}),a.jsx("div",{className:"flex flex-col",children:a.jsx(c.Z,{className:"font-medium",color:"text.primary",children:e.original.user.name})})]})}),M.accessor("dealer_remark",{header:"Dealer Remark",cell:({row:e})=>a.jsx("div",{className:"flex items-center gap-3",children:a.jsx("div",{className:"flex flex-col",children:a.jsx(c.Z,{className:"font-medium",color:"text.primary",children:e.original.dealer_remark})})})}),M.accessor("total_amount",{header:"Total",cell:({row:e})=>a.jsx(c.Z,{children:`${null!==e.original.total_amount?e.original.total_amount:"-"}`})}),M.accessor("created_at",{header:"Date",cell:({row:e})=>a.jsx(c.Z,{children:e.original.created_at.substring(0,10)})}),M.accessor("status",{header:"Status",cell:({row:e})=>a.jsx("div",{className:"flex items-center gap-3",children:a.jsx("div",{className:"flex flex-col",children:a.jsx(_.Z,{label:e.original.status,color:S.c7[e.original.status],style:{textTransform:"capitalize"},variant:"tonal",size:"small"})})})}),M.accessor("action",{header:"Action",cell:({row:e})=>a.jsx("div",{className:"flex items-center",children:a.jsx(m.Z,{children:a.jsx(d.default,{href:(0,k.U)(`/quotations/preview/${e.original.id}`,z),className:"flex",children:a.jsx("i",{className:"ri-eye-line text-textSecondary"})})})}),enableSorting:!1})],[j,N]),H=(0,w.b7)({data:N,columns:J,filterFns:{fuzzy:U},state:{rowSelection:p,globalFilter:Q},initialState:{pagination:{pageSize:10}},enableRowSelection:!0,globalFilterFn:U,onRowSelectionChange:v,getCoreRowModel:(0,f.sC)(),onGlobalFilterChange:T,getFilteredRowModel:(0,f.vL)(),getSortedRowModel:(0,f.tj)(),getPaginationRowModel:(0,f.G_)(),getFacetedRowModel:(0,f.o6)(),getFacetedUniqueValues:(0,f.JG)(),getFacetedMinMaxValues:(0,f.HO)()});return(0,r.useEffect)(()=>{E(j?.filter(e=>!i||e?.status?.toLowerCase().replace(/\s+/g,"-")===i))},[i,j,E]),(0,a.jsxs)(o.Z,{children:[(0,a.jsxs)(l.Z,{className:"flex justify-between gap-4 flex-wrap flex-col sm:flex-row items-center",children:[(0,a.jsxs)("div",{className:"flex flex-col sm:flex-row max-sm:is-full items-center gap-4",children:[a.jsx(I,{value:Q??"",onChange:e=>T(String(e)),placeholder:"Search Quotation",className:"max-sm:is-full min-is-[200px]"}),(0,a.jsxs)(g.Z,{fullWidth:!0,size:"small",className:"min-is-[175px]",children:[a.jsx($.Z,{id:"status-select",children:"Quotation Status"}),(0,a.jsxs)(x.Z,{fullWidth:!0,id:"select-status",value:i,onChange:e=>s(e.target.value),label:"Invoice Status",labelId:"status-select",children:[a.jsx(h.Z,{value:"",children:"none"}),t.quotation_status?.map(e=>a.jsx(h.Z,{value:e.name,children:e.name},e.id))]})]})]}),a.jsx(u.Z,{color:"secondary",variant:"outlined",startIcon:a.jsx("i",{className:"ri-upload-2-line text-xl"}),className:"max-sm:is-full",children:a.jsx(A.CSVLink,{className:"exportBtn",data:F,headers:D,filename:`all-quotations-${new Date().toISOString()}.csv`,children:"Export"})})]}),a.jsx("div",{className:"overflow-x-auto",children:(0,a.jsxs)("table",{className:C().table,children:[a.jsx("thead",{children:H.getHeaderGroups().map(e=>a.jsx("tr",{children:e.headers.map(e=>a.jsx("th",{children:e.isPlaceholder?null:a.jsx(a.Fragment,{children:(0,a.jsxs)("div",{className:b()({"flex items-center":e.column.getIsSorted(),"cursor-pointer select-none":e.column.getCanSort()}),onClick:e.column.getToggleSortingHandler(),children:[(0,w.ie)(e.column.columnDef.header,e.getContext()),{asc:a.jsx("i",{className:"ri-arrow-up-s-line text-xl"}),desc:a.jsx("i",{className:"ri-arrow-down-s-line text-xl"})}[e.column.getIsSorted()]??null]})})},e.id))},e.id))}),0===H.getFilteredRowModel().rows.length?a.jsx("tbody",{children:a.jsx("tr",{children:a.jsx("td",{colSpan:H.getVisibleFlatColumns().length,className:"text-center",children:"No data available"})})}):a.jsx("tbody",{children:H.getRowModel().rows.slice(0,H.getState().pagination.pageSize).map(e=>a.jsx("tr",{className:b()({selected:e.getIsSelected()}),children:e.getVisibleCells().map(e=>a.jsx("td",{children:(0,w.ie)(e.column.columnDef.cell,e.getContext())},e.id))},e.id))})]})}),a.jsx(P.Z,{rowsPerPageOptions:[10,25,50],component:"div",className:"border-bs",count:H.getFilteredRowModel().rows.length,rowsPerPage:H.getState().pagination.pageSize,page:H.getState().pagination.pageIndex,SelectProps:{inputProps:{"aria-label":"rows per page"}},onPageChange:(e,t)=>{H.setPageIndex(t)},onRowsPerPageChange:e=>H.setPageSize(Number(e.target.value))})]})},Q=({count:e,title:t})=>a.jsx("div",{children:a.jsx(o.Z,{children:(0,a.jsxs)(l.Z,{className:"flex justify-between gap-1 ",children:[(0,a.jsxs)("div",{className:"flex flex-col gap-1 flex-grow",children:[a.jsx(c.Z,{color:"text.primary",variant:"h3",children:e}),a.jsx("div",{className:"flex items-center gap-2 flex-wrap",children:a.jsx(c.Z,{variant:"h5",color:`${"Pending"===t?"orange":"User"===t?"green":"Reject"===t?"error":"Negotiation"===t?"primary":"grey"}`,children:t})})]}),a.jsx(y.default,{skin:"light",variant:"rounded",size:42,children:a.jsx("i",{class:`${"Pending"===t?"ri-pass-pending-fill":"User"===t?"ri-user-add-line":"Reject"===t?"ri-user-unfollow-fill ":"Negotiation"===t?"ri-check-double-fill":"grey"}`})})]})})}),T=()=>{let{data:e}=(0,q.kJ)(Z.aN),{data:t}=(0,q.kJ)(Z.$X);return(0,a.jsxs)(s.ZP,{container:!0,spacing:6,children:[a.jsx(s.ZP,{item:!0,md:3,xs:12,sm:6,children:a.jsx(Q,{count:t.users_aggregate.aggregate.count,title:"User"})}),a.jsx(s.ZP,{item:!0,md:3,xs:12,sm:6,children:a.jsx(Q,{count:e.pendingQuotation.aggregate.count,title:"Pending"})}),a.jsx(s.ZP,{item:!0,md:3,xs:12,sm:6,children:a.jsx(Q,{count:e.rejectedQuotation.aggregate.count,title:"Reject"})}),a.jsx(s.ZP,{item:!0,md:3,xs:12,sm:6,children:a.jsx(Q,{count:e.negotiationQuotation.aggregate.count,title:"Negotiation"})}),a.jsx(s.ZP,{item:!0,xs:12,children:a.jsx(E,{})})]})}},31538:e=>{e.exports={table:"table_table__cB3AL",cellWithInput:"table_cellWithInput__N6u24"}},87419:(e,t,i)=>{"use strict";i.r(t),i.d(t,{default:()=>l});var a=i(79703),s=i(92334);let r=(0,s.createProxy)(String.raw`D:\ALPHA PROJECT\dashboard\src\views\quotations\list\index.jsx`),{__esModule:d,$$typeof:n}=r;r.default;let o=(0,s.createProxy)(String.raw`D:\ALPHA PROJECT\dashboard\src\views\quotations\list\index.jsx#default`),l=async()=>a.jsx(o,{})}};var t=require("../../../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),a=t.X(0,[9357,6491,1598,8743,8520,168,195,785,1766,6695,3697,2598,5670,6532,6591],()=>i(5715));module.exports=a})();