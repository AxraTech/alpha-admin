...
// const NewImage = ({ files, setFiles, newData, isImageChange, setIsImageChange }) => {
//   // Hooks
...
//     } else {
//       return <img width={38} height={38} alt={'image'} src={files?.image_url} />
...
//   //         <img width={38} height={38} alt='image' src={files.image_url} />
//   //       </div>
...
//                   <>
//                     <div className='file-preview'>{renderFilePreview(files)}</div>
//                     {console.log('riles ', files)}
//                     <div>
//                       <Typography className='file-name font-medium' color='text.primary'>
//                         {files?.name ? files?.name : 'image'}
//                       </Typography>
//                       <Typography className='file-size' variant='body2'>
//                         {Math.round(files?.size / 100) / 10 > 1000
//                           ? `${(Math.round(files?.size / 100) / 10000).toFixed(1)} mb`
...
//                   </>
//                 ) : (
//                   <div className='file-preview'>{renderFilePreview(files?.image_url)}</div>
//                 )}
//                 {/* <div className='file-preview'>
//                   <img width={38} height={38} alt='image' src={files?.image_url} />
//                 </div> */}
...
const NewsImage = ({ files, setFiles, newData, isImageChange, setIsImageChange })=>{
    ...
    const renderFilePreview = (file)=>{
        // Check if the image has been changed by the user
    ...
    const handleRemoveFile = (file)=>{
        const uploadedFiles = files.filter((i)=>i.name !== file.name);
        setFiles([
            ...uploadedFiles
        ]);
    };
    ...
    const handleEditNews = async ()=>{
        ...
        try {
            ...
            if (image && image !== newData?.image_url) {
                ...
                uploadedFileUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$helper$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uploadFile"])(image, uploadData.getFileUploadUrl.fileUploadUrl, 'image');
            }
...
//# sourceMappingURL=src_400253._.js.map